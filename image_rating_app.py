...
class ImageClassifierApp:
    ...
    def setup_ui(self):
        ...
        self.thumb_slider = tk.Scale(self.left_frame, from_=40, to=160, label="Thumbnail Size", 
                                     orient=tk.HORIZONTAL, command=self.update_thumbnail_size)
    ...
    def display_thumbnails(self):
        ...
        for i, path in enumerate(self.image_list):
            ...
            panel = tk.Label(self.thumb_frame, image=tk_img, text=os.path.basename(path), compound="left", anchor="w")
